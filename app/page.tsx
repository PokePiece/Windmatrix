...
const Home = async () => {
    ...
    return (
      <section className="w-full flex-center flex-col">
        ...
        <p className="desc text-center">
          The Nerves is an open-source intelligence platform for everyone to discover, create, and share profound and actionable insights.
        </p>
  ...
  return (
    <section className="w-full flex-center flex-col">
      ...
      <p className="desc text-center">
        The Nerves are an open-source intelligence platform for everyone to discover, create, and share profound and actionable insights.
      </p>
